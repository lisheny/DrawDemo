package com.anbaoxing.drawdemo.CustomViews;
...
import com.anbaoxing.drawdemo.R;

import java.util.List;

/**
 * 这是CustomCurveChart的基础上修改的
 * 根据实际项目需求，添加了手势滑动显示标注信息，把原来的一些不需要的绘制去掉了
 * Created by lisheny on 2017/1/5.
 */
public class CustomSuperCurveChart extends View {
    ...
    public CustomSuperCurveChart(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }

    public CustomSuperCurveChart(Context context, String[] xLabel, String[] yLabel, String[] Datatime,
    ...
    public CustomSuperCurveChart(Context context) {
        super(context);
        this.mContext = context;
...
//        paintCurve.setPathEffect(pathEffect);
        ...
        paintValue2.setColor(ContextCompat.getColor(getContext(), R.color.color14));
        ...
        painDashed.setColor(ContextCompat.getColor(getContext(), R.color.color14));
